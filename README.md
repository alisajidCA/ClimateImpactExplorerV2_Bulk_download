...
- All metadata of the Climate Impact Explorer can be found on the metadata site of the Climate Impact Explorer API -> https://cie-api-v2.climateanalytics.org/api/meta/ and countryspecific metadata (including the shapefile and available provinces) can be found with the help of the ISO-Alpha-3 code of each country -> https://cie-api-v2.climateanalytics.org/api/geo-shapes/?iso=ISO_of_requested_Country
